...
Or `bash /scratch.global/lee02326/RNASeq/run_group.sh NMU nmu`     
...
File: `/scratch.global/lee02326/RNASeq/NMU/out/Counts/subread_counts.txt`    

- See `start.R` for analysis of NMU experimental group          
- Output: `top_tags.txt`      
